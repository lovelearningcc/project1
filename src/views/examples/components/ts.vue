<template>
    <div style=" background-color: #c0c0c0; margin-top: 30px;">
        <!-- //gcc_add_add -->
        <div
            style="width: 482px; float: left; margin-left:50px; background: #c0c0c0; line-height: 10px"
        >
            <div class="ms-title">定时制水设置</div>
            ...
            <el-table :data="tableData" border class="data_table">
                ...
                <el-table-column prop="name" label="定时制水时间" width="355px" align="center"></el-table-column>
        ...
        <ul>
            <li
                class="save-btn1"
                :class="color1?'open':'close'"
                @click="savebtn1"
            >{{color1?'星期一':'星期一'}}</li>

            <li
                class="save-btn2"
                :class="color2?'open':'close'"
                @click="savebtn2"
            >{{color2?'星期二':'星期二'}}</li>

            <li
                class="save-btn3"
                :class="color3?'open':'close'"
                @click="savebtn3"
            >{{color3?'星期三':'星期三'}}</li>

            <li
                class="save-btn4"
                :class="color4?'open':'close'"
                @click="savebtn4"
            >{{color4?'星期四':'星期四'}}</li>

            <li
                class="save-btn5"
                :class="color5?'open':'close'"
                @click="savebtn5"
            >{{color5?'星期五':'星期五'}}</li>

            <li
                class="save-btn6"
                :class="color6?'open':'close'"
                @click="savebtn6"
            >{{color6?'星期六':'星期六'}}</li>

            <li
                class="save-btn7"
                :class="color7?'open':'close'"
                @click="savebtn7"
            >{{color7?'星期天':'星期天'}}</li>
        </ul>
        ...
        <div class="css_inpuit">
            <div class="css_hour1">
                <el-input
                    ...
                    onfocus="this.style.textAlign='center'"
                ></el-input>
            </div>
            <div class="css_min1">
                <el-input
        ...
        >
            <div class="ms-title1">定时关机设置</div>
        ...
        <!-- gcc_add——输入框 -->
        <div class="css_inpuit1">
            <div class="css_hour11">
                <el-input
                    maxlength="2"
                    type="text"
                    onchange="this.value=this.value.replace(/[^\d]/g,'')"
...
export default {
    ...
    created: function() {
        ...
        this.ts_eid = localStorage.getItem('ms_eid');
        console.log(this.ts_eid);
