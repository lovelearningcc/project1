<template>
    <div style="width: 100%; height: 100%; position: absolute;">
        <div style="width: 50%; height: 10%; float: left;">
            <div
                class="ms-title"
                style="margin-top:10px; margin-left:30px; float:left; width: 300px;"
            >
                设备工作模式：
                <span>{{work_mode}}</span>
            </div>

            <div class="ms-title" style="margin-top:40px; margin-left:30px;">
                设备运行状态：
        ...
        <div style="width: 58%; float: left; ">
            <div class="ms-title" style="margin-left:30px; margin-top:10px; float:left;">电导率和流速</div>
            ...
            >
                <el-table-column
                    ...
                    fixed
                ></el-table-column>
                <el-table-column prop="ysdd" width="150px" align="center" label="原水电导"></el-table-column>
        ...
        <div class="ms-title6" style="width: 20%; float: left; margin-left:100px; margin-top:0px;">
            <div class="ms-title1" style="margin-top:10px; margin-left:100px;">电导率和流速远程控制</div>
            <div class="ms-title1" style="margin-top:10px; margin-left:100px;">
                原水电导：
                <span>
                    <input
                        type="search"
                    ...
                    />
                    <button
                        style="width:60px; height:30px; margin-left:10px; color:rgb(255, 255, 255); background-color: rgb(49, 126, 243);"
                        @click="bysdd"
                    >保存</button>
                </span>
            </div>

            <div class="ms-title1" style="margin-top:10px; margin-left:77px;">
                一级浓水电导：
                <span>
                    <input
                        type="search"
        ...
        <div style="width: 58%; float: left;">
            <div class="ms-title" style="margin-left:30px; margin-top:30px">报警数据显示</div>
        ...
        <div
            class="ms-title6"
            style="width: 20%; height: 21%; float: left; margin-left:100px; margin-top:20px;"
        >
            <div class="ms-title1" style=" margin-top:10px; margin-left:100px;">运行状态控制</div>
            <div class="ms-title1" style="margin-top:10px; margin-left:122px;">
                制 水：
                <el-switch
                    v-model="szs"
                    on-color="#00A854"
            ...
            <div class="ms-title1" style="margin-top:10px; margin-left:101px;">
                消毒暂停：
                <el-switch
                    v-model="sxdzt"
                    on-color="#00A854"
